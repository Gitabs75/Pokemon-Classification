...
class CustomResNet18(nn.Module):
    def __init__(self, num_classes=n_cls, dropout=0.3):
        super().__init__()
        self.in_channels = 64
    ...
    def _make_layer(self, out_channels, blocks, stride=1, dropout=0.0):
        downsample = None
        ...
        layers = [BasicBlock(self.in_channels, out_channels, stride, downsample, dropout)]
...
class CustomResNet(nn.Module):
    def __init__(self, num_classes=18, dropout=0.3):
        ...
        # ResNet34 architecture: [3, 4, 6, 3] blocks
